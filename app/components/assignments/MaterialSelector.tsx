...
const existingMaterialsList: Material[] = [
  {
    id: "1",
    title: "Basic English Grammar",
    description: "Fundamental grammar rules and exercises",
    type: "file",
    link: "/materials/grammar.pdf"
  },
...
export function MaterialSelector({
  ...
  const handleUploadMaterial = () => {
    ...
    const newMaterialComplete: Material = {
      id: String(Math.max(...existingMaterialsList.map((m) => Number(m.id))) + 1),
          ...
          <Tabs defaultValue="existing">
            ...
            <TabsContent value="existing">
              <ScrollArea className="h-[300px] pr-4">
                <div className="space-y-2">
                  {existingMaterialsList.map((material) => {
